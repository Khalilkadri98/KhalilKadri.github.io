...
export const Skills = () => {
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ["Team Leadership", "Problem Solving", "Communication", "Project Management", "Agile"],
    },
    {
    ...
    },
    {
      ...
      skills: ["AI/ML Integration", "Performance Optimization", "Responsive Design", "Accessibility", "SEO"],
    },
  ];
